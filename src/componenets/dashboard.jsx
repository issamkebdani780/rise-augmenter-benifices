        ...
        <section className="py-24 bg-slate-50 dark:bg-slate-900/50 transition-colors duration-500 overflow-hidden relative" id="dashboard">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-5xl mx-auto">
                    {/* Tabs Interface */}
                    <div className="flex flex-wrap justify-center gap-2 mb-12 p-2 bg-white dark:bg-slate-900 rounded-[28px] border border-slate-100 dark:border-white/5 shadow-xl animate-slide-up">
                        {tabs.map((tab) => (
                            <button
                                key={tab.id}
                                ...
                                className={`flex items-center gap-2 px-6 py-3 rounded-2xl text-sm font-bold transition-all ${
                                    activeTab === tab.id 
                                        ? 'bg-primary text-white shadow-lg shadow-blue-400/20 scale-105' 
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[40px] border border-slate-100 dark:border-white/5 shadow-2xl overflow-hidden animate-slide-up" style={{ animationDelay: '0.2s' }}>
                        {/* Mockup Header */}
                        <div className="h-14 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between px-8">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t(`dash_tab_${activeTab}`)} - Live</span>
                            </div>
                            <button 
                                onClick={() => addItem(activeTab)}
                                className="flex items-center gap-2 px-4 py-1.5 bg-primary text-white text-[10px] font-black rounded-full hover:bg-primary-hover active:scale-95 transition-all"
                            >
                                <Plus size={12} />
                                {t('dash_add')}
                            </button>
